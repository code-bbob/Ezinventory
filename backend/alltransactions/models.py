...
class SalesTransaction(models.Model):
    ...
    method = models.CharField(max_length=20,choices=(('cash','cash'),('fonepay','fonepay'),('card','card'),('credit','credit'),('mixed','mixed'),('transfer','transfer'), ('loyalty','loyalty'),('esewa','esewa')),default='cash')
    cash_amount = models.FloatField(null=True,blank=True,default=0)
    fonepay_amount = models.FloatField(null=True,blank=True,default=0)
    esewa_amount = models.FloatField(null=True,blank=True,default=0)
...
class DebtorTransaction(models.Model):
    ...
    amount = models.FloatField(null=True,blank=True)
    method = models.CharField(max_length=20,choices=(('cash','Cash'),('credit','Credit'),('cheque','Cheque'),('fonepay','Fonepay'),('esewa','Esewa')),default='cash')
    cheque_number = models.CharField(max_length=255,null=True,blank=True)
    cashout_date = models.DateField(null=True)
    ...
    sales_transaction = models.ForeignKey('transaction.SalesTransaction', on_delete=models.CASCADE, related_name='debtor_transactions', null=True, blank=True)
    desc = models.CharField(max_length=255, null=True, blank=True)
